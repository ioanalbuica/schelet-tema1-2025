...
public final class FloweringPlants extends Plant {
    private static final double BLOCKING_POSSIBILITY = 0.9;
    ...
    private static final double OXYGEN_INCREMENT = 6.0;
    ...
    public FloweringPlants(final FloweringPlants other) {
        super(other);
    }
    ...
    public void changeEnvironment(final int currentTime, final SimulationMap map,
        ...
        if (air != null) {
            ...
            air.setOxygenLevel(Math.round((air.getOxygenLevel() + OXYGEN_INCREMENT
