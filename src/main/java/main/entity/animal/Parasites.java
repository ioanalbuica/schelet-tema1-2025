...
public class Parasites extends Animal {
    private static final double PARASITE_ATTACKING_PROBABILITY = 9.0;
    ...
    public Parasites(final AnimalInput animalInput) {
        super(animalInput);
        setBlockingPossibility(PARASITE_ATTACKING_PROBABILITY);
    }

    public Parasites(final Parasites other) {
        super(other);
    }
    ...
    @Override
    public final void move(final int currentTime, final SimulationMap map,
